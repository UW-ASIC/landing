...
const TextureFormats = {};
{
    ...
    for (const [name, internalFormat, glformat, type, CpuArray, chn] of [
        ...
        ['r8u', GL.R8UI, GL.RED_INTEGER, GL.UNSIGNED_BYTE, Uint8Array, 1],
        ...
        ['rgba32u', GL.RGBA32UI, GL.RGBA_INTEGER, GL.UNSIGNED_INT, Uint32Array, 4],
...
//     tex(tag, spec) {
//         this.root.tex(tag, spec);
//     }

//     draw(params) {
//         this.root.draw(params)
...
// class SwissGL extends SwissGLAPI {
...
//         Inc, VP, FP, Clear,
//         Grid, Mesh, Face,
//         Blend, DepthTest, View,
//         AlphaCoverage, Aspect, ...uniforms}) {
